...
export type BaselineDraft = LegacyDraft & { flowVersion?:3; intentOther?:string; clicksOther?:string; qualityOther?:string; outingOther?:string; connectionChoice?:string; connectionOther?:string; planningChoice?:string; planningOther?:string; punctualityChoice?:string; punctualityOther?:string; legacyAnswers?:LegacyDraft };
export const emptyDraft = ():BaselineDraft => ({...legacyEmpty(),flowVersion:3,intentOther:'',clicksOther:'',qualityOther:'',outingOther:'',connectionChoice:'',connectionOther:'',planningChoice:'',planningOther:'',punctualityChoice:'',punctualityOther:''});
