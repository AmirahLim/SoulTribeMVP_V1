...
export type IdentityDetails = { setupRevision?: 1 | 2; lifeContexts?: string[]; lifeContextsPublic?: boolean; answersPublic?: boolean; ageBand?: string; ageOther?: string; country?: string; travelKm?: number };
export function validIdentity(d: IdentityDetails & {area: string}, complete = false): boolean {
  if (d.answersPublic !== undefined && typeof d.answersPublic !== 'boolean') return false;
