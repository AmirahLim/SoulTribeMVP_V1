...
type AppScreen = 'pitches'|'profile'|'invited'|'guests'|'past'|'matching'|'connection'|'threads';
...
function Phone({screen,className=''}:{screen:AppScreen;className?:string}) {
  return <figure className={styles.actualPreview+' '+className}><div className={styles.phone}><div className={styles.screen}><img src={'/images/landing/current-'+screen+'.jpg'} alt={screenDescriptions[screen]} loading="lazy" width="390" height="780"/></div></div></figure>;
}
  ...
  return <div className={styles.page}>
    ...
    <main id="main">
      <section className={styles.hero}>
        ...
        <div className={styles.heroPhones}><Phone screen="profile" className={styles.behind}/><Phone screen="pitches" className={styles.front}/></div>
      </section>
      <section id="features" className={styles.features}>
        <div className={styles.featureStory}>
          <article className={styles.storyRow}><div className={styles.storyVisual}><Phone screen="profile"/><p className={styles.caption}>Your Social Read · Your profile</p></div><div className={styles.storyCopy}><small>01 · YOUR SOCIAL READ</small><h3>A read on the way you move through friendship.</h3><p>Some people need constant contact. Some can disappear for weeks and come back like nothing happened. Some come alive around a crowded table; others need one good conversation in the corner.</p><p>Your Social Read brings together what you share: what draws you to people, what you value in friendship, your social rhythm and the things that make you want to leave the house.</p><strong>Six questions give us somewhere to start. Your Tribal Pass lets the picture get sharper over time.</strong></div></article>
        ...
        <p className={styles.caption}>Current app interface shown with fictional sample profiles and outings, not live listings.</p>
      </section>
      <section id="how" className={styles.how}>
        ...
        <div className={styles.howPhones}><Phone screen="profile" className={styles.behind}/><Phone screen="pitches" className={styles.front}/></div>
