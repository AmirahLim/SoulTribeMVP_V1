    ...
    <main id="main">
      ...
      <section id="features" className={styles.features}>
        ...
        <div className={styles.featureStory}>
          ...
          <article className={styles.storyRow}><div className={styles.storyVisual}><div className={styles.matchPair}><Phone screen="match-a"/><Phone screen="match-b"/></div><p className={styles.caption}>Why you might click · Potential friction · View Bond</p></div><div className={styles.storyCopy}><small>02 · MATCHING & RESONANCE</small><h3>Not everyone you like is like you.</h3><p>Sometimes you click because you move through the world in similar ways. Sometimes a difference gives you something worth exploring.</p><p>Soul Tribe uses the profile signals you share—your interests, friendship preferences, social rhythm and life context—to surface people worth meeting. Connection Notes help you see what connects you and where expectations differ.</p><strong>Not a compatibility percentage. A reason to look twice.</strong></div></article>
