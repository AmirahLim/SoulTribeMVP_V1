                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pb-1">
                  <div className="min-w-0 w-full overflow-hidden">
                    ...
                    <input
                      ...
                      className="w-full max-w-full min-w-0 h-11 rounded-[14px] border border-white/20 bg-[#0D1D15] px-3 py-2 text-[13.5px] text-white focus:outline-none focus:border-amber-400 box-border block text-left appearance-none [-webkit-appearance:none]"
