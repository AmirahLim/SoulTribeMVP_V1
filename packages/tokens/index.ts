...
export const THREAD_COLORS: Record<string, ThreadColorSpec> = {
  ...
  lifestyle: { name: 'Lifestyle', tone: 'emerald', wash: 'rgba(45,82,62,0.20)', accent: colors.brand.emerald, surface: colors.glass.bg, ink: colors.ink.primary },
  experience: { name: 'Outing Style', tone: 'emerald', wash: 'rgba(45,82,62,0.20)', accent: colors.brand.emerald, surface: colors.glass.bg, ink: colors.ink.primary },
  geography: { name: 'Availability', tone: 'amber', wash: 'rgba(239,185,78,0.13)', accent: colors.brand.amber, surface: colors.glass.bg, ink: colors.ink.primary },
