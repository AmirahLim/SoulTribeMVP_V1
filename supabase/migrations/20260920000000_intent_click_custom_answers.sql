begin;
-- Expand desired friend qualities only; no self-trait inference or historical rewrites.
...
begin
 ...
 if not coalesce(onboarding_selection_valid(p->'desiredQualities',array['Curious','Reliable','Emotionally open','Playful','Thoughtful','Independent','Adventurous','Open-minded','Proactive','Free-spirit','Intellectually curious','Ambitious','Other'],5,complete),false)
